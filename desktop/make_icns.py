#!/usr/bin/env python3
"""Génère desktop/patrimony.icns (icône macOS) depuis l'emblème du projet.

Recette (alignée sur l'icône Windows desktop/patrimony.ico) : canevas carré
...
Source : public/icons/icon-512.png (emblème carré du projet).
"""
import shutil
import subprocess
import tempfile
...
OUT = ROOT / "desktop" / "patrimony.icns"
